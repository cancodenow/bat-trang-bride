...
const SCENE_MODULE_IMPORTERS = {
    ...
    CookingChallengePlaceholderScene: () => import("./scenes/[2] CookingChallenge.js"),
...
const SCENE_ASSET_GROUPS = {
    ...
    Level1PassScene: ["shared-ui", "shared-audio", "story-backgrounds", "level-1"],
    CookingChallengePlaceholderScene: [],
    Level2CookingChallengeScene: ["shared-audio"],
