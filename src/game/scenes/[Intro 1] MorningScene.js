...
export default class MorningScene01 extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.image(width / 2, 40, "ui-box-infobox").setDisplaySize(180, 75).setDepth(0);
    this.add
    ...
    this.dialogueLines = [
      { text: "Taylor: I'm too excited to sleep",        charLeft: "char-wife-giggle",    charRight: "char-husband-sleepy" },
      { text: "Taylor: Baby, baby,...",                  charLeft: "char-wife",           charRight: "char-husband-sleepy" },
      { text: "Taylor: He seems not gonna wake up",      charLeft: "char-wife-curious",   charRight: "char-husband-sleepy" },
      { text: "Taylor: What's the sound? Is that mom?",  charLeft: "char-wife-surprised", charRight: "char-mom"            },
      { text: "Taylor: What should I do now?",           charLeft: "char-wife-curious",   charRight: "char-mom"            },
    ];
    ...
    this.charLeft = createCharacter(this, width * 0.2, height+ 70, "char-wife-giggle", { scale: 0.5 });
    // Right character (husband / mom) — flipped to face left
    this.charRight = createCharacter(this, width * 0.8, height + 50, "char-husband-sleepy", { scale: 0.5, flipX: true });
