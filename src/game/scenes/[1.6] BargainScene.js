...
export default class BargainScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.image(width / 2, height / 2, "marketBg").setDisplaySize(width * 1.4, height * 1.4);
    this.add.rectangle(width / 2, height / 2, width, height, 0x000000, 0.45);

    // Dialogue lines — charLeft: wife (Taylor), charRight: seller
    this.dialogueLines = [
      { text: "Seller: You're taking the tender ribs, right? That will be 160K.",                                      charLeft: "char-wife",         charRight: "char-seller"         },
      { text: "Taylor: Why is it so expensive, sis? Could you lower it to 130K?",                                      charLeft: "char-wife-curious", charRight: "char-seller"         },
      { text: "Seller: No, I'm already selling at the right price. If you're buying, I'll make it 150K for you.",      charLeft: "char-wife",         charRight: "char-seller-annoyed" },
    ];
    this.dialogueStep = 0;
    ...
    this.charRight = createCharacter(this, width * 0.8, height + 50, "char-seller", { scale: 0.5, flipX: true });
