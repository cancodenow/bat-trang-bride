...
export default class Scene02MarketInvite extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.image(width / 2, height / 2, "lv1-bg-homeyard").setDisplaySize(width, height);

    this.cameras.main.setBackgroundColor("#3a3a4a");

    // Dialogue lines — charLeft: wife, charRight: mom
    this.dialogueLines = [
      { text: "Taylor: Mom, is there anything I can help with?",                                              charLeft: "char-wife",           charRight: "char-mom"         },
      { text: "Mom: Oh Taylor, you're up so early. Go get some more sleep dear!",                             charLeft: "char-wife",           charRight: "char-mom-happy"   },
      { text: "Taylor: No, I'm fully awake, I'd like to help you. What are you doing?",                      charLeft: "char-wife-curious",   charRight: "char-mom-happy"   },
      { text: "Mom: Alright then, I'm going to the market to prepare your welcome feast. Come, go with me.", charLeft: "char-wife-giggle",    charRight: "char-mom-thrilled" },
    ];
